...
class ViewFollowup extends View{
  ...
  public function followupForm(){
    ...
    <form class="followupForm" method="post" enctype = "multipart/form-data">
        <input type="date" name="date" class="formE form-control mb-4 border-0 py-4"><br>
        <input type="text" name="comment" placeholder="comments..." class="formE form-control mb-4 border-0 py-4"><br>
        ...
        <input class="formE form-control mb-4 border-0 py-4"type="file" id="myfile" name="myfile"style="height:65px"><br>
